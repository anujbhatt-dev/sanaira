        ...
        <div className={`${mulish.className } bg-[#7E6B5E] text-white md:px-[5rem] p-4 md:py-10 mt-10 border-t-8 border-[#574235]`}>
            <div className='grid grid-cols-1 lg:grid-cols-5 gap-10'>
                <div className='md:col-span-2 flex flex-col gap-5'>
                    ...
                    <p className='text-lg font-semibold mb-1'>ANAIRA</p>
                    </div>
                ...
                <div>
                    <h4 className='text-lg font-semibold mb-4 h-[3rem] flex items-center'>Quick Links</h4>
                    <ul className='flex flex-col gap-1'>
                        <li>
                            <Link className='text-sm mb-2 hover:text-gray-400 cursor-pointer' href={"/privacy-policy"}>Privacy Policy</Link>
                        </li>
                        <li>
                            <Link className='text-sm mb-2 hover:text-gray-400 cursor-pointer' href={"/terms-and-conditions-policy"}>Terms & Conditions</Link>
                        </li>
                        <li>
                            <Link className='text-sm mb-2 hover:text-gray-400 cursor-pointer' href={"/shipping-policy"}>Shipping Policy</Link>
                        </li>
                        <li>
                            <Link className='text-sm mb-2 hover:text-gray-400 cursor-pointer' href={"/return-and-exchange-policy"}>Returns and Exchanges</Link>
                        </li>
                    </ul>
                </div>
                <div className='md:col-span-2'>
                    <h4 className='text-lg font-semibold mb-2 h-[3rem] flex items-center'>Subscribe to our newsletter</h4>
                    ...
                    <h4 className='text-lg font-semibold mb-2 h-[3rem] flex items-center'>Follow us</h4>
                    <div className='flex gap-2'>
                        <Link href={"/facebook"} className='text-sm mb-2 hover:text-gray-400 cursor-pointer'>Facebook</Link>
                        <Link href={"/instagram"} className='text-sm mb-2 hover:text-gray-400 cursor-pointer'>Instagram</Link>
                        <Link href={"/twitter"} className='text-sm mb-2 hover:text-gray-400 cursor-pointer'>Twitter</Link>
                    </div>
                </div>
            </div>
            <hr className='border-white/80 my-6'/>
